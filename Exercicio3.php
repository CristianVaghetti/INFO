...
function fazContagem() {
    ...
    //desta maneira, se tuver numeros que se repetem uma quantidade igual de vezes, ele pega o primeiro.
    //exemplo 9 repetriu 3 vezes e o 7 tambem. O programa vai imprimir o 9 como que mais se repete
